  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Haider Bukhari</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/haiderbukhari" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
      ...
      <div className="imgcontainer1 absolute violet-gradient">
        <img src={haiderpic} alt="" className="object-contain"/>
      </div>
      </div>
